...
@Module class BaseActivityModule {

  @ForActivity @Provides fun provideMainActivityView(activity: MainActivity): MainActivityView = activity
  @ForActivity @Provides fun provideMainActivityPresenter(presenter: MainActivityPresenterImp): MainActivityPresenter = presenter
}